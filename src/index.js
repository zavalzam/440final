...
app.get('/movies/:MovieID', connectDb, function(req, res, next) {
  ...
  console.log(MovieID);
  req.db.query('SELECT * FROM Movie, ActsInMovie, Movie_GenreWHERE Movie.MovieID = ? AND ActsInMovie.MovieID = Movie.MovieID AND Movie_Genre.MovieID = Movie.MovieID', [MovieID], function(err, Movies) {
